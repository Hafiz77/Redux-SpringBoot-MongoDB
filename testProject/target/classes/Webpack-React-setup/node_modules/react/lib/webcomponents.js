...
(function(scope) {
  ...
  var script = document.querySelector('script[actions*="' + file + '"]');
  var flags = {};
  if (!flags.noOpts) {
...
CustomElements.addModule(function(scope) {
  ...
  var reservedTagList = [ "annotation-xml", "color-profile", "font-face", "font-face-actions", "font-face-uri", "font-face-format", "font-face-name", "missing-glyph" ];
