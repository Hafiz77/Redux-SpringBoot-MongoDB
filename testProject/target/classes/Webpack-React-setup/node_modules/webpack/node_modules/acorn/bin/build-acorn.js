...
browserify({standalone: "acorn"})
  ...
  .transform(babelify)
  .require("./actions/index.js", {entry: true})
  .bundle()
...
function acornShimPrepare(file) {
  ...
  if (file == path.resolve(__dirname, "../actions/index.js")) {
    var sent = false
...
browserify({standalone: "acorn.loose"})
  ...
  .transform(babelify)
  .require("./actions/loose/index.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
...
browserify({standalone: "acorn.walk"})
  ...
  .transform(acornShimPrepare)
  .transform(babelify)
  .require("./actions/walk/index.js", {entry: true})
  .bundle()
  .on("error", function (err) { console.log("Error: " + err.message) })
  .pipe(acornShimComplete())
  .pipe(fs.createWriteStream("dist/walk.js"))

babel.transformFile("./actions/bin/acorn.js", function (err, result) {
