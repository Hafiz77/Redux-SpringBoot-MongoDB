describe('url-parse', function () {
  ...
  describe('auth', function () {
    ...
    it('accepts @ in pathnames', function () {
      var url = 'http://mt0.google.com/vt/lyrs=m@114&hl=en&actions=api&x=2&y=2&z=3&s='
        , parsed = parse(url);

      assume(parsed.pathname).equals('/vt/lyrs=m@114&hl=en&actions=api&x=2&y=2&z=3&s=');
      assume(parsed.username).equals('');
      assume(parsed.password).equals('');
    });
  ...
  it('accepts multiple ???', function () {
    var url = 'http://mt0.google.com/vt/lyrs=m@114???&hl=en&actions=api&x=2&y=2&z=3&s=';
    assume(parse(url).query).equals('???&hl=en&actions=api&x=2&y=2&z=3&s=');
  });
